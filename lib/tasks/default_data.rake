...
namespace :default_data  do
  ...
  task :subjects => :environment do
    Subject.create([
      { :name => "The Web", :display_order => 10, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => "The goal of this section is for you to understand the basics of the web. What web servers are, how code is interpreted, basic things like that." },
      { :name => "Term Definitions", :display_order => 20, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => nil },
      { :name => "The Command Line", :display_order => 30, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => "Familiarity with a shell environment is crucial to being a functional developer. There are no good interactive tutorials for command lines, so complete the following reading." },
      { :name => "SQL & Databases", :display_order => 40, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => "This section is all about understanding what databases are and how to query them for data." },
      ...
      { :name => "Cascading Style Sheets", :display_order => 60, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => "While HTML tells the browser what different parts of the page are, CSS says what those pieces should look like." },
      { :name => "Git: Version Control", :display_order => 70, :created_at => "2013-03-20 00:29:03", :updated_at => "2013-03-20 00:29:03", :display_order => 0, :description => "Git is a free and open source distributed version control system designed to handle everything from small to very large projects with speed and efficiency." },
      { :name => "Basics", :display_order => 80, :created_at => "2013-03-28 19:56:17", :updated_at => "2013-03-28 19:56:17", :display_order => 0, :description => "Certain aspects of coding are fundamental, learn them through javascript and ruby." },
      { :name => "Javascript", :display_order => 90, :created_at => "2013-03-28 19:56:17", :updated_at => "2013-03-28 19:56:17", :display_order => 0, :description => "" },
      ...
      { :name => "Rails", :display_order => 110, :created_at => "2013-03-28 19:56:17", :updated_at => "2013-03-28 19:56:17", :display_order => 0, :description => nil },
      { :name => "Testing", :display_order => 120, :created_at => "2013-03-28 19:56:17", :updated_at => "2013-03-28 19:56:17", :display_order => 0, :description => nil },
      { :name => "Best Practices", :display_order => 130, :created_at => "2013-03-28 19:56:17", :updated_at => "2013-03-28 19:56:17", :display_order => 0, :description => nil }
    ], :without_protection => true )
  end
